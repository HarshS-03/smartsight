...
export default function Navbar({ activePage, setActivePage, user, setUser }) {
  ...
  useEffect(() => {
    ...
    const applyTheme = () => {
      ...
      // Synchronize native Android status bar & browser chrome
  ...
  return (
    <>
      <style>{`
        ...
        /* ── Mobile Nav Collapse (Buttery Smooth 60/120fps Native Flow) ── */
      ...
      <nav className="navbar navbar-expand-lg sticky-top">
        <div className="container">
          ...
          <div className="d-flex align-items-center gap-2 ms-auto d-lg-none">
            ...
            <button
              type="button"
              className="mobile-bell-btn position-relative"
            ...
            {/* Mobile Hamburger / Cancel Toggle Button with Animated Icon */}
            <button
