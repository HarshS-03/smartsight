...
export default function NotificationsPage({ setActivePage, user }) {
  ...
  if (!isLoggedIn) {
    return (
      <div className="notifications-page min-vh-100 d-flex align-items-center justify-content-center py-4">
  ...
  const fetchNotifications = async () => {
    try {
      ...
      // Clear home screen app badge when notifications feed is opened
      try {
  ...
  return (
    <div className="notifications-page py-4 min-vh-100">
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          <div className="row align-items-center text-center text-md-start">
            <div className="col-md-8 mb-3 mb-md-0">
              ...
              <p className="reports-subtitle text-secondary mb-0">
      ...
      <div className="container">
        ...
        <div className="glass-card p-3 p-md-4 mb-4" style={{ position: 'relative', zIndex: 100, overflow: 'visible' }}>
          <div className="row g-3 align-items-center" style={{ overflow: 'visible' }}>
      ...
      {/* Floating UI Toast Notification Banner (Fallback) */}
      {toastMessage && (
        <div className="position-fixed top-0 start-50 translate-middle-x mt-4 p-3" style={{ zIndex: 10600, width: '90%', maxWidth: '420px' }}>
          <div
            className={`p-3 px-4 rounded-pill shadow-2xl d-flex align-items-center gap-3 border ${
            ...
            style={{ background: 'var(--bg-card, #ffffff)', opacity: 1, boxShadow: '0 16px 40px rgba(0,0,0,0.35)', border: '1px solid var(--border-color)' }}
          >
